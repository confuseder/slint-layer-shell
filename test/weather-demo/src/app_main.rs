...
impl AppHandler {
    pub fn new() -> Self {
        let support_add_city = false;

        let data_controller_opt: Option<WeatherControllerPointer> = None;
    ...
    pub fn initialize_ui(&mut self) {
        ...
        self.weather_display_controller
            .initialize_ui(&window, self.support_add_city);
